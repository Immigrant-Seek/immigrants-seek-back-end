...
```bash
# Frontend
git clone https://github.com/Immigrant-Seek/immigrants-seek-front-end.git
cd immigrants-seek-front-end

# Backend
git https://github.com/Immigrant-Seek/immigrants-seek-back-end.git
cd immigrants-seek-back-end
```
